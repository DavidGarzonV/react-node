...
router.post('/', [autentication_1.checkJwt], empresaController.newEmpresa);
router.put('/:id', [autentication_1.checkJwt], empresaController.updateEmpresa);
router.delete('/:id', [autentication_1.checkJwt], empresaController.deleteEmpresa);
